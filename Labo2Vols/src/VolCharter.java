public class VolCharter extends Vol{
  ...
  public VolCharter(int numVol,String destination, int jour, int mois, int an, int nombre_total_reservations, int IdAvion, boolean repas, boolean rvsiege, boolean bar, boolean divert, boolean payants, boolean wifi){
